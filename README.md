...
| [model-monitoring-drift-lab](https://github.com/srn91/model-monitoring-drift-lab)<br>[Live demo](https://model-monitoring-drift-lab.onrender.com) | Drift and delayed-outcome monitoring service with incident reports and read-only APIs. | 2,000 reference rows, 5 rolling windows, PSI `2.0372`, KS `0.6170`. |
| [ranking-serving-engine](https://github.com/srn91/ranking-serving-engine)<br>[Live demo](https://ranking-serving-engine.onrender.com) | Ranking service with query-item features, model comparison, NDCG/MAP evaluation, and top-k APIs. | 12 query groups, NDCG@5/MAP@5 model selection, feature-level score traces. |
| [recommendation-studio](https://github.com/srn91/recommendation-studio)<br>[Live demo](https://recommendation-studio.onrender.com) | Recommendation workflow with candidate scoring, cold-start fallback, diversity-aware reranking, and serving APIs. | 18 users, diversity@5 `0.4 -> 0.6`, novelty@5 `0.19 -> 0.5004`. |
