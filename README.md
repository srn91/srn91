...
|---|---|---|
| [rag-ops-platform](https://github.com/srn91/rag-ops-platform)<br>[Live API](https://rag-ops-platform.onrender.com/evaluation) | RAG service with hybrid retrieval, reranking, source citations, FastAPI endpoints, and evaluation reports. | `retrieval_hit_rate@3=1.0`, citation hit rate `1.0`, MRR `1.0`, 11 passing tests. |
| [streaming-feature-platform](https://github.com/srn91/streaming-feature-platform)<br>[Live API](https://streaming-feature-platform-demo.onrender.com/quality/summary) | Streaming feature platform using Redpanda/Kafka, Redis, DuckDB, FastAPI, quality checks, and Prometheus metrics. | Online/offline checks, freshness metrics, GCP Pub/Sub and BigQuery dry-run assets. |
| [ml-training-serving-platform](https://github.com/srn91/ml-training-serving-platform)<br>[Live API](https://ml-training-serving-platform.onrender.com/model) | ML lifecycle service with scikit-learn/PyTorch artifacts, versioned manifests, FastAPI serving, and monitoring output. | Offline-online parity delta `<=1e-6`, rollback metadata, multi-version serving. |
...
| [recommendation-studio](https://github.com/srn91/recommendation-studio)<br>[Live API](https://recommendation-studio.onrender.com/recommend/user_0001?k=5) | Recommendation workflow with candidate scoring, cold-start fallback, diversity-aware reranking, and serving APIs. | 18 users, diversity@5 `0.4 -> 0.6`, novelty@5 `0.19 -> 0.5004`. |
